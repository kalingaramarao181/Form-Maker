    ...
    <>
      <div className='form-feature-icon-container'>
        <div className='form-features'>
          ...
          <Link to="candidate-forms"><p className='forms-features'>Templates</p></Link>
